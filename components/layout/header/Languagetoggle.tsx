...
const LanguageToggle = ({ locale }: Props) => {
    ...
    <div ref={ref} className="relative" aria-label="Language switcher">
      ...
      <motion.button
        ...
        className={`
          ...
          border border-white/10 hover:border-[#cc0075]/50
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Top accent line */}
            <div className="absolute top-0 left-0 right-0 h-0.5 bg-linear-to-r from-transparent via-[#cc0075]/60 to-transparent" />
              ...
              return (
                <motion.button
                  ...
                  className={`
                    ...
                    ${
                      isActive
                        ? "bg-linear-to-r from-[#cc0075]/30 to-[#511764]/30 text-white"
                ...
                >
                  ...
                  {isActive && (
                    ...
                    >
                      <Check className="w-3.5 h-3.5 text-[#cc0075]" />
                    </motion.div>
                  )}
                </motion.button>
              );
